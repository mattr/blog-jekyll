...
Most of the examples for Rails use the <code lang="ruby">OmniAuth::Builder</code> syntax, e.g.
...
To use the Sinatra-style syntax, replace <code>use</code> with <code>Rails.application.config.middleware.use</code>, i.e.
