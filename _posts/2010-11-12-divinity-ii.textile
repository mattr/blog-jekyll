...
!images/securom-divinity-ii.png!
...
SecuROM is a bit like the Y2K 'bug'. There was only a handful of systems which would ever be affected by that bug (notably financial institutions which were reliant on systems from the 1970s); yet everywhere I went, _everything_ had to be tagged as 'Y2K compliant'. Biggest dupe in history. 
...
I can sort of understand the idea of limiting the number of machines the game can be installed on. I don't think it's particularly useful; but when you already have a basic limitation of 'one active machine per account' on Steam, I don't think you're really gaining anything from it.

So "this":http://store.steampowered.com/app/39690/ makes even less sense:

!images/securom-arcadia.png!
