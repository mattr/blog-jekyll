...
I used "whenever":http://github.com/javan/whenever to set up the schedule, which is as simple as including the file <code>config/schedule.rb</code> in the local copy of the repository. (It is possible to specify a different file; however, this is the default for whenever.)
